    ...
    <div className="min-h-screen relative overflow-hidden bg-[#f3d6c6]">
      ...
      <div className="relative z-20 flex items-center justify-center min-h-screen">
        <div className="bg-white/35 backdrop-blur-[15px] rounded-3xl border border-white/10 shadow-[0_25px_50px_rgba(0,0,0,0.2)] p-12 w-[350px] text-center">
          ...
          <div className="mt-5">
            <a href="#" className="text-[#689f38] text-xs hover:underline">
              Forgot password?
            </a>
          </div>
          <div className="mt-3 text-xs text-[#6d4c41]">
            Not a member?{' '}
            <Link href="/signup" className="text-[#689f38] font-bold hover:underline">
              Sign up!
            </Link>
          </div>
        </div>
